...
public class Assistant {
    ...
    /**
     * The description of the assistant. Optional.
     * The maximum length is 512 characters.
     */
    private String description;

    /**
     * ID of the model to use. Mandatory.
    ...
    /**
     * The system instructions that the assistant uses. Optional.
     * The maximum length is 32768 characters.
     */
    private String instructions;

    /**
     * A list of tools enabled on the assistant. Mandatory.
    ...
    /**
     * A list of file IDs attached to this assistant. Mandatory.
